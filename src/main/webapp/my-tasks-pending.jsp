...
<div class="container mt-5">
    <h3 class="mb-4">Pending Tasks</h3>
...
<%
    ...
    try {
        ...
        String sql = "SELECT t.*, u.full_name FROM tasks t JOIN users u ON t.employee_id = u.id WHERE t.employee_id = ? AND t.status = 'Pending'";
